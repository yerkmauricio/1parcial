...
public class Controller extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
     ...
     if(op.equals("grabar"))
     {
         ...
         objProducto.setPeso(Integer.parseInt(request.getParameter("peso")));
         objProducto.setTalla(request.getParameter("talla"));
         objProducto.setVacuna(request.getParameter("vacuna"));
